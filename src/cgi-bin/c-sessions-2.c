...
int main(int argc, char **argv, char **envp)
{
  ...
  printf("<br />");
  printf("<a href=\"/src/cgi-bin/c-sessions-1.cgi\">Session Page 1</a>");
  printf("<br />");
  printf("<a href=\"/src/c-cgiform.html\">C CGI Form</a>");
  printf("<br /><br />");

  // Destroy Cookie button
  printf("<form action=\"/src/cgi-bin/c-destroy-session.cgi\" method=\"get\">");
